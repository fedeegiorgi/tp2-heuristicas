...
class GapInstance
{
    public:
        ...
        std::vector<std::vector<double>> costs; // matriz m x n: linea = deposito, columna = vendedor. pos ij = costo de asignar el vendedor j al deposito i.
        std::vector<double> capacities; // vector de tamaño m. pos i = capacidad del deposito i.
